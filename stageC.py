...
CHUNK_DIR = BASE_DIR / "chunks_gemini_semantic_serial"
CHUNK_DIR.mkdir(parents=True, exist_ok=True)
OUT_PATH = BASE_DIR / "stageC_metadata_gemini_semantic_serial.json"
LOG_PATH = BASE_DIR / "gemini_request_log.txt"
...
Split the following scientific text into large, semantically coherent sections
(e.g. Introduction, Methods, Results, Discussion, Conclusion).

Each chunk should:
- Contain around 1000–2000 words.
- Preserve every word exactly (no paraphrasing or summarization).
- Keep the original order.
- Prefer paragraph or section boundaries, not sentence breaks.
